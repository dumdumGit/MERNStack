                ...
                <div className="col-auto pr-5" style={{ width: 530 }}>
                    ...
                    <div className="row" style={{marginTop:100}}>
                        <div className="col-auto" style={{ marginRight:25}}>
                            ...
                            <h6 className="mt-3">
                                {numberFormat(props.data.travelers)}{" "} <span className="text-grey-500 font-weight-light">Travelers</span>
                            </h6>
                        </div>
                        ...
                        <div className="col-auto" style={{ marginRight:25}}>
                            ...
                            <h6 className="mt-3">
                                {numberFormat(props.data.treasures)}{" "} <span className="text-grey-500 font-weight-light">Treasures</span>
                            </h6>
                        </div>
                        ...
                        <div className="col-auto" style={{ marginRight:25}}>
                            ...
                            <h6 className="mt-3">
                                {numberFormat(props.data.cities)}{" "} <span className="text-grey-500 font-weight-light">Cities</span>
                            </h6>
                        </div>
                    </div>
                </div>
